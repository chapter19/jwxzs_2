...
class CollogeAdmin(object):
    list_display=['name','id','post_code','add_time']
...
class ClassAdmin(object):
    list_display = ['name', 'id', 'post_code','grade','colloge','add_time','major']
    search_fields = ['id', 'name', 'post_code','grade','colloge','major__name']
